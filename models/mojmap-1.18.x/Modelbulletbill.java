...
public class Modelbulletbill<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "bulletbill"), "main");
	private final ModelPart bbbody;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bbbody = partdefinition.addOrReplaceChild("bbbody",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-5.0F, -6.0F, -8.0F, 10.0F, 10.0F, 12.0F, new CubeDeformation(0.0F)).texOffs(4, 33)
		...
		PartDefinition armR = partdefinition.addOrReplaceChild("armR",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-2.5F, -1.5F, -8.0F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(32, 0)
		...
		PartDefinition armL = partdefinition.addOrReplaceChild("armL",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-0.5F, -1.5F, -8.0F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(32, 0)
