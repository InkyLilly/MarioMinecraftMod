...
public class ModelSpikeZokTrooper<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "spikezoktrooper"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition armL = partdefinition.addOrReplaceChild("armL",
				CubeListBuilder.create().texOffs(32, 18)
						.addBox(4.5F, -0.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(14, 27)
		...
		PartDefinition armR = partdefinition.addOrReplaceChild("armR",
				CubeListBuilder.create().texOffs(0, 33)
						.addBox(-0.5F, -0.5F, -12.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 26)
						.addBox(-1.0F, -1.0F, -4.0F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(22, 31)
						.addBox(-1.5F, -1.5F, -5.0F, 3.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(28, 6)
						.addBox(-1.5F, -1.5F, -10.0F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(28, 0)
						.addBox(-2.5F, -2.5F, -6.0F, 5.0F, 5.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(32, 12)
						.addBox(-1.0F, -1.0F, -7.0F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(32, 15)
