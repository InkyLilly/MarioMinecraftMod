...
public class ModelHelmetZokTrooper<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "helmetzoktrooper"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition helmet = partdefinition.addOrReplaceChild("helmet", CubeListBuilder.create().texOffs(16, 37)
				.addBox(-6.0F, -15.0F, -6.0F, 12.0F, 15.0F, 12.0F, new CubeDeformation(0.0F)),
