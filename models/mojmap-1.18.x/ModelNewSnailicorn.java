...
public class ModelNewSnailicorn<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "newsnailicorn"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition legL = partdefinition.addOrReplaceChild("legL",
				CubeListBuilder.create().texOffs(28, 43)
						.addBox(-1.0F, 0.0F, -1.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(32, 34)
						.addBox(-2.0F, 4.0F, -4.0F, 4.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(20, 35)
		...
		PartDefinition legR = partdefinition.addOrReplaceChild("legR",
				CubeListBuilder.create().texOffs(36, 43)
						.addBox(-1.0F, 0.0F, -1.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 35)
						.addBox(-2.0F, 4.0F, -4.0F, 4.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(36, 13)
						.addBox(-1.5F, 3.0F, -1.5F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-2.0F, 17.0F, 0.0F));

		PartDefinition body = partdefinition.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(36, 0)
						.addBox(-4.5F, -3.25F, -6.5F, 9.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 19)
						.addBox(-4.0F, -8.0F, -5.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(36, 5)
						.addBox(-4.0F, -7.0F, -6.0F, 8.0F, 7.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 17.0F, 0.0F));

		PartDefinition cube_r1 = body.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(8, 44)
						.addBox(-0.5F, -7.0F, -0.5F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(20, 39)
		...
		PartDefinition cube_r2 = body.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-5.0F, -11.0F, 2.0F, 10.0F, 11.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(32, 19)
						.addBox(-6.0F, -12.0F, 0.0F, 12.0F, 13.0F, 2.0F, new CubeDeformation(0.0F)),
