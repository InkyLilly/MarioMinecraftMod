...
public class ModelFuzzy<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "fuzzy"), "main");
	private final ModelPart spines;
	private final ModelPart spines2;
	private final ModelPart spines3;
	private final ModelPart spines4;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition spines = partdefinition.addOrReplaceChild("spines",
				CubeListBuilder.create().texOffs(0, 32)
						.addBox(0.0F, -16.0F, -6.0F, 0.0F, 4.0F, 12.0F, new CubeDeformation(0.0F)).texOffs(0, 32)
		...
		PartDefinition spines2 = partdefinition.addOrReplaceChild("spines2",
				CubeListBuilder.create().texOffs(0, 24)
						.addBox(0.0F, -16.0F, -6.0F, 0.0F, 4.0F, 12.0F, new CubeDeformation(0.0F)).texOffs(0, 24)
		...
		PartDefinition spines3 = partdefinition.addOrReplaceChild("spines3",
				CubeListBuilder.create().texOffs(12, 24)
						.addBox(2.0F, -22.0F, -6.0F, 3.0F, 0.0F, 12.0F, new CubeDeformation(0.0F)).texOffs(12, 24)
		...
		PartDefinition spines4 = partdefinition.addOrReplaceChild("spines4",
				CubeListBuilder.create().texOffs(0, 24)
						.addBox(2.0F, -22.0F, -6.0F, 3.0F, 0.0F, 12.0F, new CubeDeformation(0.0F)).texOffs(0, 24)
		...
		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-6.0F, -12.0F, -6.0F, 12.0F, 12.0F, 12.0F, new CubeDeformation(0.0F)).texOffs(42, 0)
