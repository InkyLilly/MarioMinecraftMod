...
public class DonutPlainsBiome {
	public static Biome createBiome() {
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, PlacementUtils.register("super_mario:flower_donut_plains", VegetationFeatures.FLOWER_DEFAULT,
