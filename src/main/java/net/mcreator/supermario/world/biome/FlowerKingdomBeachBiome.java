...
public class FlowerKingdomBeachBiome {
	public static Biome createBiome() {
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, PlacementUtils.register("super_mario:flower_flower_kingdom_beach", VegetationFeatures.FLOWER_DEFAULT,
