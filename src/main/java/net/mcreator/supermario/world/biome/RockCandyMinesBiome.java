...
public class RockCandyMinesBiome {
	public static Biome createBiome() {
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("super_mario:tree_rock_candy_mines",
						FeatureUtils.register("super_mario:tree_rock_candy_mines", Feature.TREE,
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, PlacementUtils.register("super_mario:grass_rock_candy_mines", VegetationFeatures.PATCH_GRASS,
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, PlacementUtils.register("super_mario:flower_rock_candy_mines", VegetationFeatures.FLOWER_DEFAULT,
