...
public class MushroomKingdomAutumnPlainsBiome {
	public static Biome createBiome() {
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("super_mario:tree_mushroom_kingdom_autumn_plains",
						FeatureUtils.register("super_mario:tree_mushroom_kingdom_autumn_plains", Feature.TREE,
								new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(SuperMarioModBlocks.MUSHROOM_KINGDOM_JUNGLE_LOG.get().defaultBlockState()), new StraightTrunkPlacer(4, 2, 0),
										BlockStateProvider.simple(SuperMarioModBlocks.MUSHROOM_KINGDOM_LEAVES_AUTUMN.get().defaultBlockState()), new BlobFoliagePlacer(ConstantInt.of(2), ConstantInt.of(0), 3), new TwoLayersFeatureSize(1, 0, 1))
										.ignoreVines().build()),
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, PlacementUtils.register("super_mario:grass_mushroom_kingdom_autumn_plains", VegetationFeatures.PATCH_GRASS,
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, PlacementUtils.register("super_mario:flower_mushroom_kingdom_autumn_plains", VegetationFeatures.FLOWER_DEFAULT,
