...
import net.mcreator.supermario.world.features.treedecorators.SodaJungleTrunkDecorator;
import net.mcreator.supermario.world.features.treedecorators.SodaJungleLeaveDecorator;
...
public class SodaJungleBiome {
	public static Biome createBiome() {
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("super_mario:tree_soda_jungle",
						FeatureUtils.register("super_mario:tree_soda_jungle", Feature.TREE,
								new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(Blocks.JUNGLE_LOG.defaultBlockState()), new MegaJungleTrunkPlacer(12, 2, 19),
										...
										.decorators(ImmutableList.of(SodaJungleLeaveDecorator.INSTANCE, SodaJungleTrunkDecorator.INSTANCE)).build()),
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("super_mario:grass_soda_jungle", VegetationFeatures.PATCH_GRASS, List.of(NoiseThresholdCountPlacement.of(-0.8D, 5, 4), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE, BiomeFilter.biome())));
