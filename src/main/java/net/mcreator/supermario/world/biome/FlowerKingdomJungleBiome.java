...
public class FlowerKingdomJungleBiome {
	public static Biome createBiome() {
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, PlacementUtils.register("super_mario:tree_flower_kingdom_jungle", FeatureUtils.register("super_mario:tree_flower_kingdom_jungle", Feature.TREE,
				new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(SuperMarioModBlocks.FLOWER_KINGDOM_LOG.get().defaultBlockState()), new StraightTrunkPlacer(11, 2, 0),
