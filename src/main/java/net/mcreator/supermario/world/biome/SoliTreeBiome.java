...
public class SoliTreeBiome {
	public static Biome createBiome() {
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("super_mario:tree_soli_tree",
						FeatureUtils.register("super_mario:tree_soli_tree", Feature.TREE,
								new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(SuperMarioModBlocks.SOLI_TREE_LOG.get().defaultBlockState()), new StraightTrunkPlacer(3, 2, 0),
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, PlacementUtils.register("super_mario:flower_soli_tree", VegetationFeatures.FLOWER_DEFAULT,
