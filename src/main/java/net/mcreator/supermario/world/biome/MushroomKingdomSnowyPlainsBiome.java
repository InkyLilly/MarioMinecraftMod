				...
				PlacementUtils.register("super_mario:tree_mushroom_kingdom_snowy_plains",
						FeatureUtils.register("super_mario:tree_mushroom_kingdom_snowy_plains", Feature.TREE,
								new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(SuperMarioModBlocks.MUSHROOM_KINGDOM_JUNGLE_LOG.get().defaultBlockState()), new StraightTrunkPlacer(4, 2, 0),
										BlockStateProvider.simple(SuperMarioModBlocks.MUSHROOM_KINGDOM_LEAVES_WINTER.get().defaultBlockState()), new BlobFoliagePlacer(ConstantInt.of(2), ConstantInt.of(0), 3), new TwoLayersFeatureSize(1, 0, 1))
										.ignoreVines().build()),
