...
public class FlowerKingdomForestBiome {
	public static Biome createBiome() {
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, PlacementUtils.register("super_mario:tree_flower_kingdom_forest", FeatureUtils.register("super_mario:tree_flower_kingdom_forest", Feature.TREE,
