...
public class MushroomWorldSnowyPlainsBiome {
	public static Biome createBiome() {
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, PlacementUtils.register("super_mario:flower_mushroom_world_snowy_plains", VegetationFeatures.FLOWER_DEFAULT,
