...
public class MoonBiomeBiome {
	public static Biome createBiome() {
		BiomeSpecialEffects effects = new BiomeSpecialEffects.Builder().fogColor(-13434829).waterColor(4159204).waterFogColor(329011).skyColor(-13434829).foliageColorOverride(10387789).grassColorOverride(9470285).build();
