...
public class SparklingWaterBeachBiome {
	public static Biome createBiome() {
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, PlacementUtils.register("super_mario:tree_sparkling_water_beach", FeatureUtils.register("super_mario:tree_sparkling_water_beach", Feature.TREE,
				new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(SuperMarioModBlocks.ACORN_TREE_LOG.get().defaultBlockState()), new StraightTrunkPlacer(7, 2, 0),
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, PlacementUtils.register("super_mario:grass_sparkling_water_beach", VegetationFeatures.PATCH_GRASS,
