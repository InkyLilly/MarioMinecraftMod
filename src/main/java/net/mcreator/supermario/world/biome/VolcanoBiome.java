...
public class VolcanoBiome {
	public static Biome createBiome() {
		BiomeSpecialEffects effects = new BiomeSpecialEffects.Builder().fogColor(-14613500).waterColor(-6200320).waterFogColor(-6200320).skyColor(-14613500).foliageColorOverride(-11649731).grassColorOverride(-11649731).build();
