...
public class MushroomKingdomPlainsBiome {
	public static Biome createBiome() {
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, PlacementUtils.register("super_mario:tree_mushroom_kingdom_plains", FeatureUtils.register("super_mario:tree_mushroom_kingdom_plains", Feature.TREE,
				new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(SuperMarioModBlocks.SUPER_LEAF_TREE_LOG.get().defaultBlockState()), new StraightTrunkPlacer(7, 2, 0),
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, PlacementUtils.register("super_mario:grass_mushroom_kingdom_plains", VegetationFeatures.PATCH_GRASS,
