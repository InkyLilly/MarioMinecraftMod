...
public class SodaJungleLeaveDecorator extends LeaveVineDecorator {
	public static final SodaJungleLeaveDecorator INSTANCE = new SodaJungleLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("soda_jungle_tree_leave_decorator");
