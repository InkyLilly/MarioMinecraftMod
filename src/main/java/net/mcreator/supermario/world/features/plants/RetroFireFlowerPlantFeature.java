...
public class RetroFireFlowerPlantFeature extends RandomPatchFeature {
	public static RetroFireFlowerPlantFeature FEATURE = null;
	...
	private final Set<ResourceKey<Level>> generate_dimensions = Set.of(ResourceKey.create(Registry.DIMENSION_REGISTRY, new ResourceLocation("super_mario:mushroom_world_dimension")),
			ResourceKey.create(Registry.DIMENSION_REGISTRY, new ResourceLocation("super_mario:mushroom_kingdom_dimension")));

	public RetroFireFlowerPlantFeature() {
