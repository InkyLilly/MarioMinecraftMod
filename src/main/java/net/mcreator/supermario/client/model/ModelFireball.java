...
public class ModelFireball<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("super_mario", "model_fireball"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition fireball = partdefinition.addOrReplaceChild("fireball",
				CubeListBuilder.create().texOffs(0, 0).addBox(0.0F, -6.0F, -1.0F, 0.0F, 9.0F, 9.0F, new CubeDeformation(0.0F)).texOffs(12, 12).addBox(-3.0F, -3.0F, -3.0F, 6.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)),
