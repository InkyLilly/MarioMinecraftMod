...
public class ModelParaGoomba<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(39, 0).addBox(-5.0F, -6.0F, -4.0F, 10.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));
		PartDefinition wingR = partdefinition.addOrReplaceChild("wingR", CubeListBuilder.create(), PartPose.offset(0.0F, 10.0F, 6.0F));
		PartDefinition cube_r1 = wingR.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(0, 42).addBox(0.0F, -5.0F, 0.0F, 11.0F, 9.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 3.1416F, 0.0F));
		PartDefinition wingL = partdefinition.addOrReplaceChild("wingL", CubeListBuilder.create().texOffs(0, 42).addBox(0.0F, -5.0F, 0.0F, 11.0F, 9.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 10.0F, 6.0F));
