...
public class Modelbulletbill<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bbbody = partdefinition.addOrReplaceChild("bbbody",
				CubeListBuilder.create().texOffs(0, 0).addBox(-5.0F, -6.0F, -8.0F, 10.0F, 10.0F, 12.0F, new CubeDeformation(0.0F)).texOffs(4, 33).addBox(-6.0F, 0.0F, -2.0F, 12.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(0, 22)
						.addBox(-4.5F, -5.5F, 4.0F, 9.0F, 9.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(22, 22).addBox(-5.0F, -6.0F, 6.0F, 10.0F, 10.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 33)
						.addBox(4.0F, -6.0F, 7.0F, 1.0F, 10.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 33).addBox(-5.0F, -6.0F, 7.0F, 1.0F, 10.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(32, 7)
						.addBox(-4.0F, -6.0F, 7.0F, 8.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(32, 7).addBox(-4.0F, 3.0F, 7.0F, 8.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 20.0F, 0.0F));
		PartDefinition armR = partdefinition.addOrReplaceChild("armR",
				CubeListBuilder.create().texOffs(0, 0).addBox(-2.5F, -1.5F, -8.0F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(32, 0).addBox(-2.0F, -1.0F, -5.0F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition armL = partdefinition.addOrReplaceChild("armL",
				CubeListBuilder.create().texOffs(0, 0).addBox(-0.5F, -1.5F, -8.0F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(32, 0).addBox(0.0F, -1.0F, -5.0F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(5.0F, 22.0F, -1.0F, 0.4215F, -0.3614F, -0.1572F));
