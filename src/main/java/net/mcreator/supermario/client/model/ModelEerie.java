...
public class ModelEerie<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition ArmL = partdefinition
				.addOrReplaceChild(
						"ArmL", CubeListBuilder.create().texOffs(12, 22).addBox(4.0F, -3.0F, -5.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
								.texOffs(0, 0).addBox(4.0F, -4.0F, -4.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
						PartPose.offset(0.0F, 24.0F, 0.0F));
		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(0, 15).addBox(-3.0F, -12.0F, -2.0F, 7.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(17, 20)
		...
		PartDefinition ArmR = partdefinition
				.addOrReplaceChild(
						"ArmR", CubeListBuilder.create().texOffs(12, 22).addBox(3.0F, -3.0F, -5.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
								.texOffs(0, 0).addBox(3.0F, -4.0F, -4.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
