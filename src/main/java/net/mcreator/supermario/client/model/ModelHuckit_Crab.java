...
public class ModelHuckit_Crab<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition legL = partdefinition
				.addOrReplaceChild(
						"legL", CubeListBuilder.create().texOffs(0, 42).addBox(0.5F, -2.0F, -5.0F, 5.0F, 2.0F, 3.0F, new CubeDeformation(0.0F))
								.texOffs(0, 34).addBox(0.5F, -3.0F, -2.0F, 5.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)),
						PartPose.offset(0.0F, 24.0F, 0.0F));
		PartDefinition legR = partdefinition
				.addOrReplaceChild(
						"legR", CubeListBuilder.create().texOffs(0, 42).addBox(1.0F, -2.0F, -5.0F, 5.0F, 2.0F, 3.0F, new CubeDeformation(0.0F))
								.texOffs(0, 34).addBox(1.0F, -3.0F, -2.0F, 5.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)),
						PartPose.offset(-6.5F, 24.0F, 0.0F));
		PartDefinition body = partdefinition.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(30, 20).addBox(-3.0F, -19.0F, -2.0F, 6.0F, 4.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						.addBox(-6.0F, -11.0F, -6.0F, 12.0F, 8.0F, 12.0F, new CubeDeformation(0.0F)).texOffs(0, 20)
						.addBox(-5.0F, -15.0F, -5.0F, 10.0F, 4.0F, 10.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));
		PartDefinition ArmR = partdefinition.addOrReplaceChild("ArmR",
				CubeListBuilder.create().texOffs(0, 0).addBox(-8.0F, -5.5F, -2.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(36, 0)
						.addBox(-12.0F, -9.0F, -3.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(36, 39)
						.addBox(-15.0F, -8.0F, -3.0F, 3.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(35, 34)
						.addBox(-14.0F, -4.0F, -3.0F, 6.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));
