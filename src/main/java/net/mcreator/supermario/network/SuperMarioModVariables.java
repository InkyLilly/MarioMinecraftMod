...
public class SuperMarioModVariables {
	...
	public static void init(FMLCommonSetupEvent event) {
		SuperMarioMod.addNetworkMessage(PlayerVariablesSyncMessage.class, PlayerVariablesSyncMessage::buffer, PlayerVariablesSyncMessage::new,
	...
	public static class EventBusVariableHandlers {
		...
		public static void clonePlayer(PlayerEvent.Clone event) {
			...
			clone.Invincibility_Leaf_Active = original.Invincibility_Leaf_Active;
			if (!event.isWasDeath()) {
			}
		}
	}
	...
	public static class PlayerVariables {
		...
		public boolean Invincibility_Leaf_Active = false;
		...
		public Tag writeNBT() {
			...
			nbt.putBoolean("Invincibility_Leaf_Active", Invincibility_Leaf_Active);
			return nbt;
		}
		...
		public void readNBT(Tag Tag) {
			...
			Invincibility_Leaf_Active = nbt.getBoolean("Invincibility_Leaf_Active");
		}
	}
		...
		public static void handler(PlayerVariablesSyncMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
			...
			context.enqueueWork(() -> {
				if (!context.getDirection().getReceptionSide().isServer()) {
					...
					variables.Invincibility_Leaf_Active = message.data.Invincibility_Leaf_Active;
				}
			});
