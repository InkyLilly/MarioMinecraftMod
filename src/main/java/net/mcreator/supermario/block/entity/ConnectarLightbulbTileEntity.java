package net.mcreator.supermario.block.entity;
...
public class ConnectarLightbulbTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	public AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public ConnectarLightbulbTileEntity(BlockPos pos, BlockState state) {
		super(SuperMarioModBlockEntities.CONNECTAR_LIGHTBULB.get(), pos, state);
	}
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<ConnectarLightbulbTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<ConnectarLightbulbTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return new TextComponent("connectar_lightbulb");
	}
	...
	public Component getDisplayName() {
		return new TextComponent("Connectar Lightbulb");
	}
