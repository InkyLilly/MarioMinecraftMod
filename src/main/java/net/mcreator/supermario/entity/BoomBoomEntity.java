...
public class BoomBoomEntity extends Monster implements IAnimatable {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(BoomBoomEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(BoomBoomEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(BoomBoomEntity.class, EntityDataSerializers.STRING);
	...
	public BoomBoomEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(SuperMarioModEntities.BOOM_BOOM.get(), world);
	}

	public BoomBoomEntity(EntityType<BoomBoomEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "boomboomtexture");
	}
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(BoomBoomEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
