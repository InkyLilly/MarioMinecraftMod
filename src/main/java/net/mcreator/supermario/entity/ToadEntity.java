...
public class ToadEntity extends Monster implements IAnimatable {
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		if (SPAWN_BIOMES.contains(event.getName()))
			event.getSpawns().getSpawner(MobCategory.CREATURE).add(new MobSpawnSettings.SpawnerData(SuperMarioModEntities.TOAD.get(), 20, 1, 1));
	}

	public ToadEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(SuperMarioModEntities.TOAD.get(), world);
	}
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "newtoadnormaltexture");
	}
	...
	public static void init() {
		SpawnPlacements.register(SuperMarioModEntities.TOAD.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
