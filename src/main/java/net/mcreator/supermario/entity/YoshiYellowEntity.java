...
public class YoshiYellowEntity extends Monster implements IAnimatable {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(YoshiYellowEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(YoshiYellowEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(YoshiYellowEntity.class, EntityDataSerializers.STRING);
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		if (SPAWN_BIOMES.contains(event.getName()))
			event.getSpawns().getSpawner(MobCategory.CREATURE).add(new MobSpawnSettings.SpawnerData(SuperMarioModEntities.YOSHI_YELLOW.get(), 1, 1, 1));
	}

	public YoshiYellowEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(SuperMarioModEntities.YOSHI_YELLOW.get(), world);
	}

	public YoshiYellowEntity(EntityType<YoshiYellowEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "newyoshiyellowtexture");
	}
	...
	public static void init() {
		SpawnPlacements.register(SuperMarioModEntities.YOSHI_YELLOW.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(YoshiYellowEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
