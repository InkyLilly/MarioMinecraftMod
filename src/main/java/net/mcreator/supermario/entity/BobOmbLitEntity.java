...
public class BobOmbLitEntity extends Monster {
	public BobOmbLitEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(SuperMarioModEntities.BOB_OMB_LIT.get(), world);
	}

	public BobOmbLitEntity(EntityType<BobOmbLitEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
		...
		BobOmbEntityIsHurtProcedure.execute(world, this.getX(), this.getY(), this.getZ());
		return retval;
	}
