...
import net.mcreator.supermario.procedures.DryBonesEntityIsHurtProcedure;
import net.mcreator.supermario.init.SuperMarioModEntities;

import java.util.Set;

@Mod.EventBusSubscriber
public class DryBonesEntity extends Monster implements IAnimatable {
	...
	private static final Set<ResourceLocation> SPAWN_BIOMES = Set.of(new ResourceLocation("super_mario:haunted_soda_jungle"), new ResourceLocation("super_mario:volcano"));

	@SubscribeEvent
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		if (SPAWN_BIOMES.contains(event.getName()))
			event.getSpawns().getSpawner(MobCategory.MONSTER).add(new MobSpawnSettings.SpawnerData(SuperMarioModEntities.DRY_BONES.get(), 20, 4, 4));
	}

	public DryBonesEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(SuperMarioModEntities.DRY_BONES.get(), world);
	}
	...
	public boolean hurt(DamageSource source, float amount) {
		DryBonesEntityIsHurtProcedure.execute(this.level, this.getX(), this.getY(), this.getZ(), this);
	...
	public static void init() {
		SpawnPlacements.register(SuperMarioModEntities.DRY_BONES.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
