...
public class KoopaBlueEntity extends Monster implements IAnimatable {
	...
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(KoopaBlueEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(KoopaBlueEntity.class, EntityDataSerializers.STRING);
	...
	public KoopaBlueEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(SuperMarioModEntities.KOOPA_BLUE.get(), world);
	}

	public KoopaBlueEntity(EntityType<KoopaBlueEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
	...
	public static void init() {
		SpawnPlacements.register(SuperMarioModEntities.KOOPA_BLUE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
