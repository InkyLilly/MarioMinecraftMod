...
import net.mcreator.supermario.procedures.BowserJrPhase2EntityDiesProcedure;
import net.mcreator.supermario.init.SuperMarioModEntities;

public class BowserJrPhase2Entity extends Monster implements IAnimatable {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(BowserJrPhase2Entity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(BowserJrPhase2Entity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(BowserJrPhase2Entity.class, EntityDataSerializers.STRING);
	...
	public BowserJrPhase2Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(SuperMarioModEntities.BOWSER_JR_PHASE_2.get(), world);
	}

	public BowserJrPhase2Entity(EntityType<BowserJrPhase2Entity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	public void die(DamageSource source) {
		super.die(source);
		BowserJrPhase2EntityDiesProcedure.execute(this.level, this.getX(), this.getY(), this.getZ());
	}
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(BowserJrPhase2Entity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
