...
import net.mcreator.supermario.procedures.KoopaGreenDeathTimeIsReachedProcedure;
import net.mcreator.supermario.init.SuperMarioModEntities;

import java.util.Set;

@Mod.EventBusSubscriber
public class KoopaGreenEntity extends Monster implements IAnimatable {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(KoopaGreenEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(KoopaGreenEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(KoopaGreenEntity.class, EntityDataSerializers.STRING);
	...
	private static final Set<ResourceLocation> SPAWN_BIOMES = Set.of(new ResourceLocation("super_mario:haunted_soda_jungle"), new ResourceLocation("super_mario:mushroom_world_snowy_plains"), new ResourceLocation("super_mario:sparkling_water_beach"),
			new ResourceLocation("super_mario:frosted_glacier"), new ResourceLocation("super_mario:meringue_clouds"), new ResourceLocation("super_mario:mushroom_world_desert"), new ResourceLocation("super_mario:mushroom_world_plains"),
	...
	public KoopaGreenEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(SuperMarioModEntities.KOOPA_GREEN.get(), world);
	}

	public KoopaGreenEntity(EntityType<KoopaGreenEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
	...
	public static void init() {
		SpawnPlacements.register(SuperMarioModEntities.KOOPA_GREEN.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(KoopaGreenEntity.RemovalReason.KILLED);
			this.dropExperience();
			KoopaGreenDeathTimeIsReachedProcedure.execute(this.level, this.getX(), this.getY(), this.getZ());
		}
	}
