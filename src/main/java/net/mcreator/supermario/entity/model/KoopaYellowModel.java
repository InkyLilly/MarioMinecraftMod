...
public class KoopaYellowModel extends AnimatedGeoModel<KoopaYellowEntity> {
	...
	public ResourceLocation getAnimationFileLocation(KoopaYellowEntity entity) {
		return new ResourceLocation("super_mario", "animations/newkoopa.animation.json");
	}

	@Override
	public ResourceLocation getModelLocation(KoopaYellowEntity entity) {
		return new ResourceLocation("super_mario", "geo/newkoopa.geo.json");
	}
	...
	@Override
	public void setCustomAnimations(KoopaYellowEntity animatable, int instanceId, AnimationEvent animationEvent) {
