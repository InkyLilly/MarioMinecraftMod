...
public class BoomerangBroModel extends AnimatedGeoModel<BoomerangBroEntity> {
	...
	public ResourceLocation getAnimationFileLocation(BoomerangBroEntity entity) {
		return new ResourceLocation("super_mario", "animations/boomerangbro.animation.json");
	}

	@Override
	public ResourceLocation getModelLocation(BoomerangBroEntity entity) {
		return new ResourceLocation("super_mario", "geo/boomerangbro.geo.json");
	}
	...
	@Override
	public void setCustomAnimations(BoomerangBroEntity animatable, int instanceId, AnimationEvent animationEvent) {
