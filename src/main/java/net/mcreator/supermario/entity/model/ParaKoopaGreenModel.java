...
public class ParaKoopaGreenModel extends AnimatedGeoModel<ParaKoopaGreenEntity> {
	...
	@Override
	public ResourceLocation getTextureLocation(ParaKoopaGreenEntity entity) {
		return new ResourceLocation("super_mario", "textures/entities/" + entity.getTexture() + ".png");
	}

	@Override
	public void setCustomAnimations(ParaKoopaGreenEntity animatable, int instanceId, AnimationEvent animationEvent) {
