...
public class YoshiBrownModel extends AnimatedGeoModel<YoshiBrownEntity> {
	...
	@Override
	public ResourceLocation getTextureLocation(YoshiBrownEntity entity) {
		return new ResourceLocation("super_mario", "textures/entities/" + entity.getTexture() + ".png");
	}

	@Override
	public void setCustomAnimations(YoshiBrownEntity animatable, int instanceId, AnimationEvent animationEvent) {
