...
public class FireBroModel extends AnimatedGeoModel<FireBroEntity> {
	...
	public ResourceLocation getAnimationFileLocation(FireBroEntity entity) {
		return new ResourceLocation("super_mario", "animations/firebro.animation.json");
	}

	@Override
	public ResourceLocation getModelLocation(FireBroEntity entity) {
		return new ResourceLocation("super_mario", "geo/firebro.geo.json");
	}
	...
	@Override
	public void setCustomAnimations(FireBroEntity animatable, int instanceId, AnimationEvent animationEvent) {
