...
public class YoshiLightBlueEntity extends Monster implements IAnimatable {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(YoshiLightBlueEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(YoshiLightBlueEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(YoshiLightBlueEntity.class, EntityDataSerializers.STRING);
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		if (SPAWN_BIOMES.contains(event.getName()))
			event.getSpawns().getSpawner(MobCategory.CREATURE).add(new MobSpawnSettings.SpawnerData(SuperMarioModEntities.YOSHI_LIGHT_BLUE.get(), 1, 1, 1));
	}

	public YoshiLightBlueEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(SuperMarioModEntities.YOSHI_LIGHT_BLUE.get(), world);
	}

	public YoshiLightBlueEntity(EntityType<YoshiLightBlueEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "newyoshilightbluetexture");
	}
	...
	public static void init() {
		SpawnPlacements.register(SuperMarioModEntities.YOSHI_LIGHT_BLUE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(YoshiLightBlueEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
