...
public class ClubbaEntity extends Monster implements IAnimatable {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(ClubbaEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(ClubbaEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(ClubbaEntity.class, EntityDataSerializers.STRING);
	...
	public ClubbaEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(SuperMarioModEntities.CLUBBA.get(), world);
	}

	public ClubbaEntity(EntityType<ClubbaEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "clubbatexture");
	}
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(ClubbaEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
