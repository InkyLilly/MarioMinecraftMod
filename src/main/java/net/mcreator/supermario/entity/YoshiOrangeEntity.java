...
public class YoshiOrangeEntity extends Monster implements IAnimatable {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(YoshiOrangeEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(YoshiOrangeEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(YoshiOrangeEntity.class, EntityDataSerializers.STRING);
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		if (SPAWN_BIOMES.contains(event.getName()))
			event.getSpawns().getSpawner(MobCategory.CREATURE).add(new MobSpawnSettings.SpawnerData(SuperMarioModEntities.YOSHI_ORANGE.get(), 1, 1, 1));
	}

	public YoshiOrangeEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(SuperMarioModEntities.YOSHI_ORANGE.get(), world);
	}

	public YoshiOrangeEntity(EntityType<YoshiOrangeEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "newyoshiorangetexture");
	}
	...
	public static void init() {
		SpawnPlacements.register(SuperMarioModEntities.YOSHI_ORANGE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(YoshiOrangeEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
