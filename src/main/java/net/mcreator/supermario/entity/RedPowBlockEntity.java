...
public class RedPowBlockEntity extends AbstractArrow implements ItemSupplier {
	...
	public void onHitBlock(BlockHitResult blockHitResult) {
		...
		RedPowBlockProjectileHitsBlockProcedure.execute(this.level, blockHitResult.getBlockPos().getX(), blockHitResult.getBlockPos().getY(), blockHitResult.getBlockPos().getZ());
	}
