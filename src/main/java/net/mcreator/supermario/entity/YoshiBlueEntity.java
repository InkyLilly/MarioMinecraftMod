...
public class YoshiBlueEntity extends Monster implements IAnimatable {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(YoshiBlueEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(YoshiBlueEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(YoshiBlueEntity.class, EntityDataSerializers.STRING);
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		if (SPAWN_BIOMES.contains(event.getName()))
			event.getSpawns().getSpawner(MobCategory.CREATURE).add(new MobSpawnSettings.SpawnerData(SuperMarioModEntities.YOSHI_BLUE.get(), 1, 1, 1));
	}

	public YoshiBlueEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(SuperMarioModEntities.YOSHI_BLUE.get(), world);
	}

	public YoshiBlueEntity(EntityType<YoshiBlueEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "newyoshibluetexture");
	}
	...
	public static void init() {
		SpawnPlacements.register(SuperMarioModEntities.YOSHI_BLUE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(YoshiBlueEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
