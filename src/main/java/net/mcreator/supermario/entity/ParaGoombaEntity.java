...
public class ParaGoombaEntity extends Monster implements IAnimatable {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(ParaGoombaEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(ParaGoombaEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(ParaGoombaEntity.class, EntityDataSerializers.STRING);
	...
	public ParaGoombaEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(SuperMarioModEntities.PARA_GOOMBA.get(), world);
	}

	public ParaGoombaEntity(EntityType<ParaGoombaEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "newgoombaparatexture");
	}
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(2, new RandomStrollGoal(this, 0.8, 20) {
			...
			protected Vec3 getPosition() {
				Random random = ParaGoombaEntity.this.getRandom();
				double dir_x = ParaGoombaEntity.this.getX() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_y = ParaGoombaEntity.this.getY() + ((random.nextFloat() * 2 - 1) * 16);
				double dir_z = ParaGoombaEntity.this.getZ() + ((random.nextFloat() * 2 - 1) * 16);
