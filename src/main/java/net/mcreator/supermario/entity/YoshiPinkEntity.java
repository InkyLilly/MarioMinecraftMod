...
public class YoshiPinkEntity extends Monster implements IAnimatable {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(YoshiPinkEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(YoshiPinkEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(YoshiPinkEntity.class, EntityDataSerializers.STRING);
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		if (SPAWN_BIOMES.contains(event.getName()))
			event.getSpawns().getSpawner(MobCategory.CREATURE).add(new MobSpawnSettings.SpawnerData(SuperMarioModEntities.YOSHI_PINK.get(), 1, 1, 1));
	}

	public YoshiPinkEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(SuperMarioModEntities.YOSHI_PINK.get(), world);
	}

	public YoshiPinkEntity(EntityType<YoshiPinkEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "newyoshipinktexture");
	}
	...
	public static void init() {
		SpawnPlacements.register(SuperMarioModEntities.YOSHI_PINK.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(YoshiPinkEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
