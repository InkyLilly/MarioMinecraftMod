...
import net.mcreator.supermario.world.biome.TwisteeIslandBiome;
...
import net.mcreator.supermario.world.biome.SoliTreeBiome;
import net.mcreator.supermario.world.biome.SodaJungleBiome;
import net.mcreator.supermario.world.biome.SlippenglideIslandBiome;
import net.mcreator.supermario.world.biome.SkorcheenIslandBiome;
import net.mcreator.supermario.world.biome.RumblaIslandBiome;
import net.mcreator.supermario.world.biome.RockCandyMinesBiome;
import net.mcreator.supermario.world.biome.RaynforstIslandBiome;
import net.mcreator.supermario.world.biome.OffandonIslandBiome;
...
import net.mcreator.supermario.world.biome.MushroomKingdomAutumnPlainsBiome;
import net.mcreator.supermario.world.biome.MoonBiomeBiome;
import net.mcreator.supermario.world.biome.MerrygoIslandBiome;
import net.mcreator.supermario.world.biome.MeringueCloudsBiome;
import net.mcreator.supermario.world.biome.LottacoinsIslandBiome;
import net.mcreator.supermario.world.biome.LayerCakeDesertBiome;
import net.mcreator.supermario.world.biome.JellyfishIslandBiome;
import net.mcreator.supermario.world.biome.JadeJungleBiome;
...
import net.mcreator.supermario.world.biome.FortressZokketBiome;
...
import net.mcreator.supermario.world.biome.FlorallIslandBiome;
import net.mcreator.supermario.world.biome.DonutPlainsBiome;
import net.mcreator.supermario.world.biome.DesolattIslandBiome;
import net.mcreator.supermario.world.biome.ConductorIslandBiome;
import net.mcreator.supermario.world.biome.ChocolateIslandBiome;
import net.mcreator.supermario.world.biome.BulbfishIslandBiome;
import net.mcreator.supermario.world.biome.AllsandIslandBiome;
...
public class SuperMarioModBiomes {
	...
	public static final RegistryObject<Biome> JADE_JUNGLE = REGISTRY.register("jade_jungle", () -> JadeJungleBiome.createBiome());
	public static final RegistryObject<Biome> RUMBLA_ISLAND = REGISTRY.register("rumbla_island", () -> RumblaIslandBiome.createBiome());
	public static final RegistryObject<Biome> TWISTEE_ISLAND = REGISTRY.register("twistee_island", () -> TwisteeIslandBiome.createBiome());
	public static final RegistryObject<Biome> RAYNFORST_ISLAND = REGISTRY.register("raynforst_island", () -> RaynforstIslandBiome.createBiome());
	public static final RegistryObject<Biome> FLORALL_ISLAND = REGISTRY.register("florall_island", () -> FlorallIslandBiome.createBiome());
	public static final RegistryObject<Biome> MUSHROOM_KINGDOM_AUTUMN_PLAINS = REGISTRY.register("mushroom_kingdom_autumn_plains", () -> MushroomKingdomAutumnPlainsBiome.createBiome());
	public static final RegistryObject<Biome> DESOLATT_ISLAND = REGISTRY.register("desolatt_island", () -> DesolattIslandBiome.createBiome());
	public static final RegistryObject<Biome> LOTTACOINS_ISLAND = REGISTRY.register("lottacoins_island", () -> LottacoinsIslandBiome.createBiome());
	public static final RegistryObject<Biome> MERRYGO_ISLAND = REGISTRY.register("merrygo_island", () -> MerrygoIslandBiome.createBiome());
	public static final RegistryObject<Biome> ALLSAND_ISLAND = REGISTRY.register("allsand_island", () -> AllsandIslandBiome.createBiome());
	public static final RegistryObject<Biome> BULBFISH_ISLAND = REGISTRY.register("bulbfish_island", () -> BulbfishIslandBiome.createBiome());
	public static final RegistryObject<Biome> SKORCHEEN_ISLAND = REGISTRY.register("skorcheen_island", () -> SkorcheenIslandBiome.createBiome());
	public static final RegistryObject<Biome> SLIPPENGLIDE_ISLAND = REGISTRY.register("slippenglide_island", () -> SlippenglideIslandBiome.createBiome());
	public static final RegistryObject<Biome> OFFANDON_ISLAND = REGISTRY.register("offandon_island", () -> OffandonIslandBiome.createBiome());
	public static final RegistryObject<Biome> FORTRESS_ZOKKET = REGISTRY.register("fortress_zokket", () -> FortressZokketBiome.createBiome());
	public static final RegistryObject<Biome> CONDUCTOR_ISLAND = REGISTRY.register("conductor_island", () -> ConductorIslandBiome.createBiome());
	public static final RegistryObject<Biome> JELLYFISH_ISLAND = REGISTRY.register("jellyfish_island", () -> JellyfishIslandBiome.createBiome());
	public static final RegistryObject<Biome> SOLI_TREE = REGISTRY.register("soli_tree", () -> SoliTreeBiome.createBiome());
